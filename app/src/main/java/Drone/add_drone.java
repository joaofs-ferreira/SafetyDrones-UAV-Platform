...
This class implements the **screen for adding a new drone** to the user's collection.  
It interacts with **Firebase Authentication** and **Firebase Realtime Database** to store drone data.

Key responsibilities:
- Collects **drone details**: name, model, weight, autonomy, and speed.  
- **Validates inputs** to ensure all fields are filled and numeric values are correct.  
- Adds the drone to Firebase under the authenticated user's ID.  
- Updates **shared preferences** with the last added drone information.  
- Provides **success and error feedback** via Toast messages.  
- Closes the activity after successfully adding a drone.
