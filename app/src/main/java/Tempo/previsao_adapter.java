...
RecyclerView adapter for displaying weather forecasts.  
- Receives a list of `TempoResponde.Day`.  
- Formats dates to show "Today", "Tomorrow", or the full date.  
- Displays temperature, conditions, wind, and weather icon.  
- Uses Glide to load icons from a URL.
...
public class PrevisaoAdapter extends RecyclerView.Adapter<PrevisaoAdapter.PrevisaoViewHolder> {
    ...
    private String formatarData(String dataOriginal) {
        try {
            ...
            SimpleDateFormat soData = new SimpleDateFormat("yyyyMMdd", new Locale("pt", "PT")); 
