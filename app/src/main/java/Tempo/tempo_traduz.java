##TraduzTempo.java
Utility class for weather conditions translation and icon mapping.

- **`traduzir(String condicoes)`**  
  Translates weather condition strings from English to Portuguese and capitalizes them for display.

- **`getIconFileName(String condicaoOriginal, boolean isDay)`**  
  Returns the corresponding weather icon filename based on the condition and whether it is day or night. 
  Handles complex conditions like thunderstorms, rain, snow, fog, and more.

This class is used by the weather forecast UI to display translated text and appropriate weather icons dynamically.
