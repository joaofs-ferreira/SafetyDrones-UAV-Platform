...
This class implements the **screen for editing an existing drone**.  
It interacts with **Firebase Authentication** and **Firebase Realtime Database** to update drone data.

Key responsibilities:
- Receives **drone details via Intent** and pre-fills the input fields.  
- Validates inputs for **name, model, weight, autonomy, and speed**.  
- Updates the drone information in **Firebase** under the authenticated user's ID.  
- Updates **shared preferences** with the last edited drone ID.  
- Provides **success and error feedback** using Toast messages.  
- Closes the activity after successfully updating the drone.
