##TempoService.java
Retrofit interface for fetching weather data from Visual Crossing API.

- `getWeather()`: Performs a GET request to retrieve current and daily weather forecast for Porto, Portugal.  
- Returns a `Call<TempoResponde>` containing the weather data model.
